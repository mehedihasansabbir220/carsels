...
const MostFaviroteCar = () => {
    const { register, handleSubmit } = useForm();
    const onSubmit = data => {
        // console.log(data)
        fetch(`https://car-sels.herokuapp.com/mostFavirote`, {
            method: 'POST',
            ...
            <Container className="d-flex align-items-center justify-content-center "
                ...
                <div className="w-100 " style={{ maxWidth: "400px" }}>
                    <Card className='bg-dark text-light'>
                        <Card.Body>
                            <h2 className="text-center mb-4">Add A New Favirote Car  </h2>
...
export default MostFaviroteCar;